...
(function (window) {
    ...
    const N8N_WEBHOOK_URL = "https://waseem-c.app.n8n.cloud/webhook/cf5218f8-b140-4e24-9622-77a65ed0a13f";
    try {
        ...
        if (!response.ok) {
            console.warn("N8N webhook returned an error:", response.status, await response.text());
        } else {
